...
**[Download Keen v0.2.15](https://github.com/SirPrizeNZ/keen/releases/download/v0.2.15/keen-0.2.15-32bit-armeabi-v7a.apk)** ·
[Release notes](https://github.com/SirPrizeNZ/keen/releases/tag/v0.2.15) ·
[SHA256SUMS](https://github.com/SirPrizeNZ/keen/releases/download/v0.2.15/SHA256SUMS)
...
**[64-bit build](https://github.com/SirPrizeNZ/keen/releases/download/v0.2.15/keen-0.2.15-64bit-arm64-v8a.apk)** · 20.5 MiB · 64-bit ARM (`arm64-v8a`)
...
```bash
adb install -r keen-0.2.15-32bit-armeabi-v7a.apk
```
